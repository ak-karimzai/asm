...
#include "inc/double_cmp.h"

static void add_fpu(double lhs, double rhs, size_t n_times)
{
    double res;
...
static void asm_add_fpu(double lhs, double rhs, size_t n_times)
{
    double res;
    for (size_t i = 0; i < n_times; i++)
    {
...
static void mul_fpu(double lhs, double rhs, size_t n_times)
{
    double res;
    for (size_t i = 0; i < n_times; i++)
        res = lhs * rhs;
...
static void asm_mul_fpu(double lhs, double rhs, size_t n_times)
{
    double res;
    for (size_t i = 0; i < n_times; i++)
    {
...
static double function_exec_time(void (*_func)(double, double, size_t), \
                          double lhs, double rhs, size_t repeat_time)
{
